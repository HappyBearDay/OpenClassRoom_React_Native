      ...
      return (
        <ScrollView style={styles.scrollview_container}>
          ...
          <Text style={styles.default_text}>Sorti le 
                        {moment(this.state.film.release_date).format("DD/MM/YYYY")} </Text>
          <Text style={styles.default_text}>Note : 
                        {this.state.film.vote_average}/10</Text>
          
          <Text style={styles.default_text}>Nombre de votes : 
                        {this.state.film.vote_count}</Text>
